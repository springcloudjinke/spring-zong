...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAI4Fu5ZSwhmSoHiKuNUFhN";
    private String accessKeySecret = "YrUL3z94zqHDLsM2ONI1viBybLWu85";
    // 空间
    private String bucketName = "xhh123";
    // 文件存储目录
    private String filedir = "xhh/";
